...
begin
  ...
  begin
    ...
    begin
      ...
      ShowMessage('Produto já referenciado no site no cadastro Nº'+data.Values['resource_id'].value);
      abort;
    end;
    end;
...
else if (comboSite.ItemIndex = 0) AND (queryProdutosCOD_SITE.AsInteger > 0) then
// CONDIÇÃO UPDATE
begin
